...
app.layout = html.Div([
    ...
    html.H2("feature importance distribution plot"),
    dcc.Graph(id='important-features-graph',responsive =True)
...
def update_output_train(n_clicks, value):  # define the function reaching output from input
    if n_clicks != 0:
        ...
        figure = {'data':[{'x':feature_scores.index.tolist(),'y':feature_scores.tolist()}],'layout': {'title': 'important features distribution'}}
