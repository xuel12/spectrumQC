...
app.layout = html.Div([
    ...
    html.Div(id='spectrum quality training',children='AUC score will be displayed here'),  # add a section to store and display output
    html.H2("Prediction"),
    ...
    html.H3("ROC curve"),
    dcc.Graph(id='ROC curve',figure = px.line(default_train_df, x="fpr", y="tpr", title='ROC curve will be displayed below'), responsive =True)
